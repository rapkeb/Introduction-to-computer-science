...
public class TestBalance {
    ...
    public static void main(String[] args) {
        ...
        t1.insert(new BankAccount("i", 9, 0));
        t1.insert(new BankAccount("i", 10, 0));
